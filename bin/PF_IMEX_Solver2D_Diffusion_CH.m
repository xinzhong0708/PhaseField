function [E, mu] = PF_IMEX_Solver2D_Diffusion_CH(M, kappa, dx, dy, nx, ny, E, mu, dt_phy, Chi, s, chiRelFloor, chiAbsFloor)
...
%
% Non-periodic version implemented with reflective (zero-flux / Neumann) boundaries.
%
% Inputs:
