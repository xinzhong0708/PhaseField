...
[STATE_BG,DIAG_BG] = PF_CH_Coarse_Background_CS( ...
    STATE_REF,PARAM,MODEL,GRID,PHYS,NUM,STATE_COEF);

[STATE_NEW,DIAG_LOC] = PF_Coupled_ACCH_LETangent_BandCorrection_CS( ...
    STATE_REF,STATE_BG,PARAM,MODEL,GRID,PHYS,NUM,STATE_BG);
