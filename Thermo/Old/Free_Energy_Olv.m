...
X_Fe_2d       = linspace(-0.2,2/3+0.2,51);
X_Mg_2d       = linspace(-0.2,2/3+0.2,51); [X_Fe_2d,X_Mg_2d]=ndgrid(X_Fe_2d,X_Mg_2d);
X_Fe_2d       = [X_Fe_2d(:) ; linspace(1e-4,2/3-1e-4,0)'];
X_Mg_2d       = [X_Mg_2d(:) ; linspace(2/3-1e-4,1e-4,0)'];

w             = 1e8;
g_2d          = interp1(X_Fe,g,X_Fe_2d)/2 + interp1(X_Mg,g,X_Mg_2d)/2;
g_2d          = g_2d + w*(2/3-X_Fe_2d-X_Mg_2d).^2;
...
%Testing and compare
X_Fe_test             = linspace(-0.2,2/3+0.2,51);
X_Mg_test             = linspace(-0.2,2/3+0.2,51);
...
save('Data_Olv','c_Fe_Olv','c_Mg_Olv','pval_Olv','f_Olv','dcdmu_Olv')
