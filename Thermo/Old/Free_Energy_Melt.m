...
%Construct free energy
X_Fe_2d       = linspace(-0.2,0.80,61);
X_Mg_2d       = linspace(-0.2,0.80,61); [X_Fe_2d,X_Mg_2d]=ndgrid(X_Fe_2d,X_Mg_2d);
g_2d          = griddata(X_Fe,X_Mg,g,X_Fe_2d,X_Mg_2d);
X_Fe_2d       = X_Fe_2d(:);
X_Mg_2d       = X_Mg_2d(:);
g_2d          = g_2d(:);
...
%Testing and compare
X_Fe_test             = linspace(-0.2,0.85,161);
X_Mg_test             = linspace(-0.2,0.85,161); 
...
save('Data_Melt','c_Fe_Melt','c_Mg_Melt','pval_Melt','f_Melt','dcdmu_Melt')
