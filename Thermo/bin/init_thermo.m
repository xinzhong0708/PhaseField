...
for i_sol = 1:length(mineral)
    ...
    if strcmp(mineral{i_sol},'Melt(H18)')
        ...
        z_name = {'pq','psl','pwo','pjd','pek','pti','pkj','pct','pol','sumT','mgM','feM','CaM','AlM','sumM','xh','xv'};
        z_fac = {'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)'  '4./(3*yct+4)' '4./(3*yct+4)' '4./(3*yct+4)' '4./(3*yct+4)' '4./(3*yct+4)' '4./(3*yct+4)' '4./(3*yct+4)'};
        mtpl = {'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)' 'ones(size(p,1),1)'  'ones(size(p,1),1)' '-1*ones(size(p,1),1)' '((3*yct)/4 + 1)', '((3*yct)/4 + 1)', '((3*yct)/4 + 1) - yct./CaM', '((3*yct)/4 + 1) - yct./AlM', '-((3*yct)/4 + 1) + 2*yct./sumM', '(3*yct + 4)/2', '((3*yct)/2 + 2)-(3/2*yct)./xv'};
