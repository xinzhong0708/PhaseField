function [STATE_CORR,DIAG] = PF_CH_CoarseFine_Corrector_CS(STATE_TIME,STATE_IT,PARAM,MODEL,GRID,PHYS,NUM)
%PF_CH_COARSEFINE_CORRECTOR_CS Two-level CH corrector.
%
% Idea:
